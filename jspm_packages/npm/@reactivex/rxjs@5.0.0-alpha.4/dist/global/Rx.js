...
(function(Buffer, process) {
  (function e(t, n, r) {
    ...
    5: [function(require, module, exports) {
      ...
      "./operators/debounceTime": 43,
      "./operators/defaultIfEmpty": 44,
      "./operators/delay": 45,
      "./operators/dematerialize": 46,
      "./operators/distinctUntilChanged": 47,
      "./operators/do": 48,
      "./operators/every": 49,
      "./operators/expand": 51,
      "./operators/filter": 52,
      "./operators/finally": 53,
      "./operators/first": 54,
      "./operators/groupBy": 56,
      "./operators/ignoreElements": 57,
      "./operators/last": 58,
      "./operators/map": 59,
      "./operators/mapTo": 60,
      "./operators/materialize": 61,
      "./operators/merge": 63,
      "./operators/merge-static": 62,
      "./operators/mergeAll": 65,
      "./operators/mergeMap": 67,
      "./operators/mergeMapTo": 69,
      "./operators/multicast": 70,
      "./operators/observeOn": 72,
      "./operators/partition": 73,
      "./operators/publish": 74,
      "./operators/publishBehavior": 75,
      "./operators/publishReplay": 76,
      "./operators/reduce": 77,
      "./operators/repeat": 78,
      "./operators/retry": 79,
      "./operators/retryWhen": 80,
      "./operators/sample": 81,
      "./operators/sampleTime": 82,
      "./operators/scan": 83,
      "./operators/share": 84,
      "./operators/shareReplay": 85,
      "./operators/single": 86,
      "./operators/skip": 87,
      "./operators/skipUntil": 88,
      "./operators/startWith": 89,
      "./operators/subscribeOn": 90,
      "./operators/switch": 91,
      "./operators/switchMap": 92,
      "./operators/switchMapTo": 93,
      "./operators/take": 94,
      "./operators/takeUntil": 95,
      "./operators/throttle": 96,
      "./operators/timeout": 97,
      "./operators/timeoutWith": 98,
      "./operators/toArray": 99,
      "./operators/toPromise": 100,
      "./operators/window": 101,
      "./operators/windowCount": 102,
      "./operators/windowTime": 103,
      "./operators/windowToggle": 104,
      "./operators/windowWhen": 105,
      "./operators/withLatestFrom": 106,
      "./operators/zip": 109,
      "./operators/zip-static": 107,
      "./operators/zipAll": 110,
      "./schedulers/immediate": 116,
      "./schedulers/nextTick": 117,
      "./subjects/BehaviorSubject": 118,
      "./subjects/ReplaySubject": 119,
      "./util/ArgumentOutOfRangeError": 121,
      "./util/EmptyError": 122
    }],
    6: [function(require, module, exports) {
      ...
      "./Subscriber": 7,
      "./Subscription": 8,
      "./subjects/SubjectSubscription": 120
    }],
    ...
    17: [function(require, module, exports) {
      ...
      "../Observable": 3,
      "../operators/observeOn-support": 71,
      "../schedulers/immediate": 116,
      "../util/Symbol_iterator": 126,
      "../util/Symbol_observable": 127,
      "./ArrayObservable": 9,
